...
if(isset($_POST['submit_request'])){
    ...
    $message = "<div class='alert alert-success'>Request submitted. Technician assignment will run at your preferred time.</div>";
...
Report a maintenance issue and choose a preferred repair interval.
</p>
...
<input type="text" name="hostel" class="form-control" placeholder="e.g. Hostel 4" required>
</div>

<div class="col-md-6">
<label class="form-label">Room Number</label>
<input type="text" name="room" class="form-control" placeholder="e.g. 211" required>
</div>
